	...
	<body>
		...
		<div class="container-fluid admin" >
			...
			<div class="well col-lg-12">
				<button class="btn btn-success" type="button" id="new_emp_btn"><span class="fa fa-plus"></span> Add new Employee </button>
				<br />
				<br />
				...
				$.ajax(
					...
					success:function(respond)
					{
						if(typeof respond !=undefined)
						{
							...
							$('[name="firstname"]').val(respond.firstname)
							$('[name="lastname"]').val(respond.lastname)
							$('[name="middlename"]').val(respond.middlename)
							$('[name="department"]').val(respond.department)
							$('[name="position"]').val(respond.position)
